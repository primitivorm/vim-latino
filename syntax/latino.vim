...
syn region	latOperParen 	matchgroup=latParenSep	start="(" end=")" contains=@latOperGroup
if !exists("g:latsyn_noerror") && !exists("g:latsyn_noopererror")
 syn match	latOperError	")"
endif
